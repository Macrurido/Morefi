...
#' fitted regression are stored previously in the List_TCCT list. Calculations for ARSS are
#' also stored here
#'
...
#'
#'
#' @return: List_TCCT calculations for ARSS are stored here
#'
#'
#' @seealso: FDist from the package stats (version 3.6.2)
#'
#'
#' @examples: ARSS <- fn_ARSS(List_TCCT, i,  alfa = 0.05)
#'
#'
#' @export:
...
#' @References: Chen Y., Jackson, D. A., & Harvey, H. H. 1992. A comparison of
